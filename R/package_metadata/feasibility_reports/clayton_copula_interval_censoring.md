...
`R/EDI/R/inference_survival_KK_clayton_copula.R` defines two classes:

- **`InferenceSurvivalKKClaytonCopulaIVWC`** (line 36) — fits the
...
- **`InferenceSurvivalKKClaytonCopulaOneLik`** (line 468) — fits *one*
...
(`inference_survival_KK_clayton_copula.R:389+`) calls
`fast_weibull_regression_general_cpp(y=..., y_L=..., y_R=..., X=...)`
directly (confirmed at `inference_survival_KK_clayton_copula.R:219-227`,
