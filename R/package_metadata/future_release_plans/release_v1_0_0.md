...
5. **[x] `save_load_api.md`** — the serialization contract. EDI's core use
   ...
   moved back to `../new_feature_plans/` carrying a new section E —
   Inference-object serialization, originally scoped as `release_v1_1_0.md
   → TODO-17r` and **moved 2026-09-06 to `release_v1_2_0.md → TODO-19`**
   (lighten-1.1.0 pass, user decision). The Design-side work recorded
   here remains done and shipped in v1.0.0; nothing about this item
   reopened.)
