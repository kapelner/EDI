...
per `../new_feature_plans/optimizer_diagnostics_report.md`'s TODO-4 fix that added this OR
...
2. **Option 1 implementation:** derive the reparameterized score/Hessian
   ...
   `../new_feature_plans/cold_starts.md` documentation), and re-validate against
