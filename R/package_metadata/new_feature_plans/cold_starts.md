...
- [ ] TODO-11: **General parametric survival models** (used by `InferenceSurvivalGLMMWeibullFrailtyLoggammaOneLik` and related KK survival paths) — `EDI/src/fast_survival_models_optim.cpp:681`.
