...
| `multivariate_response_type_report.md` | K endpoints | `InferenceMultiEndpointComposite` (per-outcome CCT via `InferenceSuite`, or a pinned single model; Holm/max-IUT across outcomes); joint SUR/Hotelling explicitly deferred | decision-gated, v1.1.0 TODO-6 |
