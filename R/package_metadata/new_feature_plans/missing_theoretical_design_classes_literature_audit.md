...
| 5 | **Tabord-Meehan (2023, *REStud*) stratification trees** | pilot data ⇒ tree partition of X + within-stratum allocation maximizing asymptotic efficiency | asymptotic | author R | **missing** — scoped 2026-09-10, `optimal_design_objective_extensions.md` §H (`release_v2_0_0.md → TODO-5b-iii`) | medium–high | medium |
...
| 30 | Bertsimas, Korolko & Weinstein (2019, *Oper. Res.*) online MIO covariate-adaptive optimization | per-arrival MIO minimizing moment discrepancy with lookahead and a randomization constraint; finite-sample bounds | replay | none | **missing** — scoped 2026-09-10, `modern_covariate_balancing_designs.md` (`DesignSeqOneByOneOnlineMIO`; `release_v2_0_0.md → TODO-5b-iv`) | medium | medium |
| 31 | Chipman, Mayberry & Greevy, "Rematching on-the-fly: sequential matched randomization and a case for covariate-adjusted randomization," arXiv:2203.13797 (2022, v3 2023; no confirmed journal venue — citation verified in-repo on 2026-08-18, see `new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md`) | a rematching variant of KK matching-on-the-fly; already a candidate in the JSS plan §3.7 | — | none public | **candidate** | medium | small–medium (on top of KK14) |
...
| 48 | Multi-arm Atkinson (2002), multi-arm ARM/PSR, K-arm online balancing walk, K-arm bandits / controlled FLGI | K | 1 | K-arm versions of 2C/2D rows | **planned** (`response_adaptive_randomization.md`'s K-arm-generalization sections and TODO-7..10, amended 2026-09-16) | rides multi-arm track; Thompson/bandits wave scoped for v2.0.0, Atkinson/ARM-PSR wave lowest priority within that file |
