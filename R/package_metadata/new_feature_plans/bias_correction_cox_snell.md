...
| Clayton copula Weibull AFT | `InferenceSurvivalKKWeibullFrailtyLoggammaOneLik` | `fast_survival_models_optim.cpp` | Copula-coupled survival margins | **Very Hard** | Copula dependence parameter adds another nuisance block with no standard closed form | research-scale, no confident estimate |
...
| Weibull frailty | `InferenceSurvivalKKWeibullFrailtyNormalOneLik` | `fast_weibull_frailty.cpp` | Frailty (random-effect survival), integrated likelihood | **Very Hard** | Same marginal-likelihood issue as GLMM | research problem |
