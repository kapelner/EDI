...
`new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md`) already leans on: the suite's job is to make
...
(cross-ref `new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md` §4 item 7), do not let it be
...
- **(b) Two-stage combination** — group rows by `estimand`
  (`new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md` §3.5b's own `estimand` column already exists
...
2. **Even if it were statistically valid, it reintroduces the exact problem
   ...
   `new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md`, the Madigan et al. 2013 framing): a
...
- [x] TODO-19: Docs — roxygen section on `combined_evidence` stating the
  ...
  Cross-reference `new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md` §3.5b/§4 item 7 so the paper
  ...
  **Done 2026-08-19:** New "Combined Evidence interpretation caveat"
  ...
  TODO specifies. `new_research_ideas/paper/JSS_EDI_exposition/JSS_EDI_exposition.md`'s §3.5b interpretive-caveat
