...
| Expanded | `gosset::nicabean` | CRAN: gosset | 1.5.1 | GPL-3 | 15039 | 0 | `item` (10 varieties, randomly assigned as 3-variety incomplete blocks) | `rank` (1=best..3=worst, per trait) | ordinal | Documented tricot on-farm randomized bean-variety trial, Nicaragua (557 farmers x 9 traits, long format) | On-farm tricot bean-variety RCT, Nicaragua |
...
| Expanded | `TukeyC::SPET` | CRAN: TukeyC | 1.4-0 | GPL (>= 2) | 64 | 0 | `tra` (8: 7 legume cover crops + maize) | `y` (yield) | continuous | Documented real agricultural-textbook randomized block design (Gomes 1990), 4 blocks x 2 years x 8 treatments | Legume cover-crop RCBD |
