...
#'
#' @keywords internal
InferenceAbstractKKCondLogitGLMMLegacyOrig = define_inference_class(
...
#' }
#' @export
InferenceIncidKKCondLogitGLMMIVWCLegacyOrig = R6::R6Class("InferenceIncidKKCondLogitGLMMIVWC",
	lock_objects = FALSE,
	inherit = InferenceAbstractKKCondLogitGLMMLegacyOrig,
	public = list(
	),
	private = list(
...
#' }
#' @export
InferenceIncidKKCondLogitGLMMOneLikLegacyOrig = R6::R6Class("InferenceIncidKKCondLogitGLMMOneLik",
	lock_objects = FALSE,
	inherit = InferenceAbstractKKCondLogitGLMMLegacyOrig,
	public = list(
...
#'
#' @export
InferencePropKKGLMMLegacyOrig = R6::R6Class("InferencePropKKGLMM",
	lock_objects = FALSE,
	inherit = InferenceAbstractKKCondLogitGLMMLegacyOrig,
	public = list(
