...
// [[Rcpp::export]]
List qr_reduce_full_rank_cpp( const Eigen::Map<Eigen::MatrixXd>& X) {
...
// [[Rcpp::export]]
List qr_reduce_preserve_cols_cpp( const Eigen::Map<Eigen::MatrixXd>& X,
		IntegerVector required_cols) {
