...
#' @R6method InferenceOrdinalCloglogRegr$approximate_randomization_distribution_beta_hat_T
#' @template rand-approx-distribution-beta-hat-t
NULL

#' @R6method InferenceOrdinalCloglogRegr$supports_rand_pval_for_incidence
#' @template rand-supports-pval-incidence
NULL

#' @R6method InferenceOrdinalCloglogRegr$compute_rand_two_sided_pval
