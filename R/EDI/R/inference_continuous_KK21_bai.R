...
#' \code{\link[EDI:InferenceBaiAdjustedTKK14]{InferenceBaiAdjustedTKK14}} for
...
#' @R6method InferenceBaiAdjustedTKK21$approximate_randomization_distribution_beta_hat_T
#' @template rand-approx-distribution-beta-hat-t
NULL

#' @R6method InferenceBaiAdjustedTKK21$supports_rand_pval_for_incidence
#' @template rand-supports-pval-incidence
NULL

#' @R6method InferenceBaiAdjustedTKK21$compute_rand_two_sided_pval
