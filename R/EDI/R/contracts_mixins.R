...
EDI_COMPONENT_SPECS = list(
	...
	IncidenceKKGComputation = list(
		...
		provides_public_methods = c(
			...
			"compute_subsampling_two_sided_pval", "compute_subsampling_two_sided_pval_generic",
			"compute_subsampling_confidence_interval", "compute_subsampling_confidence_interval_generic",
			"compute_m_out_of_n_bootstrap_two_sided_pval", "compute_m_out_of_n_bootstrap_two_sided_pval_generic",
			"compute_m_out_of_n_bootstrap_confidence_interval", "compute_m_out_of_n_bootstrap_confidence_interval_generic"
		),
		provides_private_methods = c(
		...
		provides_capabilities = "count_likelihood_plumbing",
			...
			ZeroAugmentedCountLikelihood = list(
				...
				provides_private_methods = c(
					...
					"zero_augmented_failed_fit_diagnostics",
					"fit_hurdle_poisson_components_independently",
					"compute_treatment_estimate_during_randomization_inference",
					"za_family",
					"za_description",
			...
			OrdinalContinuationRatioLikelihood = list(
				...
				IncidenceGComputation = list(
					...
					provides_private_methods = c(
						...
						"compute_rr_jackknife_wald_confidence_interval",
						"compute_rr_resampling_pivot",
						"compute_rr_subsampling_two_sided_pval",
						"compute_rr_subsampling_confidence_interval",
						"compute_rr_m_out_of_n_bootstrap_two_sided_pval",
						"compute_rr_m_out_of_n_bootstrap_confidence_interval",
