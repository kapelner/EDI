...
#' @R6method InferenceContinKKRobustRegrIVWC$approximate_randomization_distribution_beta_hat_T
#' @template rand-approx-distribution-beta-hat-t
NULL

#' @R6method InferenceContinKKRobustRegrIVWC$supports_rand_pval_for_incidence
#' @template rand-supports-pval-incidence
NULL

#' @R6method InferenceContinKKRobustRegrIVWC$compute_rand_two_sided_pval
