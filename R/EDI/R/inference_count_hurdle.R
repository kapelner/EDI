...
#' }
#' @export
InferenceCountHurdleNegBin = define_inference_class(
	classname = "InferenceCountHurdleNegBin",
	inherit = Inference,
	...
	overrides = list(
		...
		private = c(
			"cached_mod", "cached_vc_params", "supports_likelihood_tests", "supports_lik_ratio_param_bootstrap",
