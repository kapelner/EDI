...
get_optimization_dispatch_policy = function() {
  list(
    ...
    inference_class_overrides = c(
      ...
      "KKGLMM$"                 = "lbfgs",
      "GLMMWeibullFrailtyNormalIVWC$"   = "lbfgs",
      "GLMMWeibullFrailtyNormalOneLik$" = "lbfgs",
      ...
      "InferenceSurvivalGLMMWeibullFrailtyLoggammaOneLik$" = "lbfgs",
  ...
  list(
    ...
    jackknife = list(
      ...
      n_conditioned_overrides = list(
        ...
        wn("^InferenceSurvivalGLMMWeibullFrailtyLoggammaIVWC$", n_min = 1000L),
    ...
    bayesian_boot = list(
      ...
      n_conditioned_overrides = list(
        ...
        wn("^InferenceSurvivalGLMMWeibullFrailtyLoggammaOneLik$", n_min = 500L),
    ...
    rand = list(
      ...
      n_conditioned_overrides = list(
        wn("^InferencePropBetaRegr$", n_max = 200L),
        wn("^InferenceOrdinalKKCondAdjCatLogitRegr$", n_max = 200L),
        wn("^InferenceSurvivalGLMMWeibullFrailtyLoggammaOneLik$", n_max = 200L),
        wn("^InferenceSurvivalKKStratCoxPHOneLik$", n_max = 200L),
        wn("^InferenceSurvivalGLMMWeibullFrailtyNormalIVWC$", n_max = 200L),
