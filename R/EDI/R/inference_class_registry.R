...
EDI_INFERENCE_ESTIMAND_TAGS = list(
	...
	InferenceCountHurdleNegBin = "log_rate_ratio_conditional",
	InferenceCountHurdlePoisson = "log_rate_ratio_marginal",
	InferenceCountKKCondPoissonOneLik = "log_rate_ratio_conditional",
	InferenceCountKKGLMM = "log_rate_ratio_conditional",
	InferenceCountKKHurdlePoissonIVWC = "log_rate_ratio_conditional",
	InferenceCountKKHurdlePoissonOneLik = "log_rate_ratio_conditional",
	...
	InferenceCountZeroInflatedNegBin = "log_rate_ratio_conditional",
	InferenceCountZeroInflatedPoisson = "log_rate_ratio_marginal",
	InferenceIncidBinomialIdentityRiskDiff = "mean_difference",
	InferenceIncidCMH = "mean_difference",
	...
	InferenceIncidExtendedRobins = "mean_difference",
	InferenceIncidGCompRiskDiff = "mean_difference",
	...
	InferenceIncidWald = "mean_difference",
	...
	InferencePropBetaRegr = "log_odds_ratio_marginal",
	InferencePropFractionalLogit = "log_odds_ratio_marginal",
	InferencePropGCompMeanDiff = "mean_difference",
	InferencePropKKGEE = "log_odds_ratio_marginal",
	InferencePropKKGLMM = "logit_effect_proportion_mean_conditional",
	InferencePropKKQuantileRegrIVWC = "quantile_regression_effect",
...
build_simple_estimator_behavior_record = function(name) {
	...
	list(
		...
		intentional_capabilities = target$intentional_capabilities,
		intentional_public_methods = intentional_methods,
		legacy_optional_surface = setdiff(current_optional_methods, c(intentional_methods, "get_supported_testing_types", "set_testing_type")),
		notes = target$notes
	)
}
