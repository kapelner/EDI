...
inference_path_labels = c(  
  ...
  InferenceIncidKKCondLogitGLMMIVWC = "Clogit + GLMM",
  InferenceIncidKKCondLogitGLMMOneLik = "Clogit + GLMM",
  InferencePropKKQuantileRegrIVWC = "Quantile (Prop)",
  InferencePropKKQuantileRegrOneLik = "Quantile (Prop)",
  InferenceSurvivalGLMMWeibullFrailtyLoggammaIVWC = "Clayton Copula",
  InferenceSurvivalGLMMWeibullFrailtyLoggammaOneLik = "Clayton Copula",
