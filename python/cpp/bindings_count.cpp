...
void bind_count(py::module_& m) {
    ...
    "Fast Poisson regression via IRLS or L-BFGS. No R-side roxygen documents this "
    "raw kernel directly (fast_poisson_regression.cpp has none); parameters follow "
    "the same conventions used throughout this module.\n\n"
    "Parameters\n"
    "----------\n"
    "X : ndarray\n"
    ...
    py::arg("estimate_only") = false,
    py::arg("weights") = py::none(),
    "Fast negative binomial regression via L-BFGS. Parameters sourced from "
    "R/EDI/man/fast_neg_bin_cpp.Rd.\n\n"
    "Parameters\n"
    "----------\n"
    "X : ndarray\n"
    ...
    "Parameters sourced from R/EDI/man/ documentation for fast_zinb_cpp (Xc/Xz here "
    "correspond to that function's X/Xzi).\n\n"
    "Parameters\n"
    "----------\n"
    "Xc : ndarray\n"
    ...
    "[beta_cond, beta_zi, log_theta]). Always computes the variance -- fast_zinb is "
    "the dedicated point-estimate-only backend. Same argument meanings as fast_zinb "
    "(see its docstring); Xc/Xz correspond to R/EDI/man/'s fast_zinb_cpp X/Xzi.\n\n"
    "Parameters\n"
    "----------\n"
    "Xc : ndarray\n"
    "    Numeric matrix of predictors for the count component (including\n"
    ...
    "components on the Python side. Parameters sourced from R/EDI/man/ "
    "documentation for fast_zero_augmented_poisson_cpp.\n\n"
    "Parameters\n"
    "----------\n"
    "X : ndarray\n"
    ...
    "with full vcov (params order: [beta_cond, beta_zi]). Always computes the variance -- "
    "fast_zero_augmented_poisson is the dedicated point-estimate-only backend. Same "
    "argument meanings as fast_zero_augmented_poisson (see its docstring).\n\n"
    "Parameters\n"
    "----------\n"
    "X : ndarray\n"
    "    Matrix of predictors for the conditional (count) component.\n"
    ...
    "(for parameter index j) are always computed when !estimate_only. Parameters "
    "sourced from R/EDI/man/ documentation for fast_hurdle_negbin_with_var_cpp "
    "(X_r/y_r/X_hurdle_r there correspond to X/y/X_hurdle here).\n\n"
    "Parameters\n"
    "----------\n"
    "X : ndarray\n"
    ...
    py::arg("optimization_alg") = "lbfgs",
    py::arg("warm_start_fisher_info") = py::none(),
    "Fast zero-truncated negative binomial count regression via L-BFGS (the "
    "count-component fit used inside fast_hurdle_negbin, also exposed standalone). "
    "No R-side roxygen documents this raw kernel directly "
    "(fast_hurdle_negbin.cpp's roxygen documents the hurdle export, not this "
    "truncated-count-only one); parameters follow the same conventions used\n"
    ...
    "singletons) regression via Newton's method for KK designs. No R-side roxygen "
    "documents this raw fit kernel directly (fast_cpoisson_combined.cpp's roxygen "
    "documents the Hessian helper get_cpoisson_combined_hessian_cpp, whose "
    "argument names/meanings match the ones below).\n\n"
    "Parameters\n"
    "----------\n"
    "yT_v : ndarray\n"
