...
repository — issues, pull requests, discussions, and commits — and any other
official EDI communication channel), and also applies when an individual is
officially representing the community in public spaces. Examples of
representing our community include using an official e-mail address, posting
...
**kapelner@gmail.com**. All complaints will be reviewed and investigated
promptly and fairly.
...
created by Coraline Ada Ehmke, version 2.1, available at
